      ...
      <CardContent className="p-6 relative z-10">
        <div className="flex items-center justify-between space-x-4">
          ...
          <div className="flex-shrink-0">
            {isAvailable ? (
              <Button 
                className="bg-gradient-to-r from-[#72B742] to-[#72B742]/90 hover:from-[#72B742]/90 hover:to-[#72B742] text-white font-medium py-2 px-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-sm"
              >
                Launch →
              </Button>
            ) : (
              <Button 
                disabled
                className="bg-gray-200 dark:bg-gray-700 text-gray-400 py-2 px-4 rounded-xl cursor-not-allowed text-sm"
              >
                Coming Soon
              </Button>
            )}
